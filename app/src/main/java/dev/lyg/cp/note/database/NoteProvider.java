...
public class NoteProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "dev.lyg.cp.note.provider";
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            case NOTE_DIR:
                return "vnd.android.cursor.dir/vnd.dev.lyg.cp.note.provider.note";
            case NOTE_ITEM:
                return "vnd.android.cursor.item/vnd.dev.lyg.cp.note.provider.note";
            case TABS_DIR:
                return "vnd.android.cursor.dir/vnd.dev.lyg.cp.note.provider.tabs";
            case TABS_ITEM:
                return "vnd.android.cursor.item/vnd.dev.lyg.cp.note.provider.tabs";
        }
        return null;
    }
