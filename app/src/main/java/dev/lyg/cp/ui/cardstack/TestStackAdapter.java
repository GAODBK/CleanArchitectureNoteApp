...
import dev.lyg.cp.ui.cardstack.StackAdapter.StackAdapter;
...
public class TestStackAdapter extends StackAdapter<Integer> {
    ...
    protected CardStackView.ViewHolder onCreateView(ViewGroup parent, int viewType) {
        View view;
        if (viewType == R.layout.list_card_item_larger_header) {
        ...
        } else if (viewType == R.layout.list_card_item_with_no_header) {
